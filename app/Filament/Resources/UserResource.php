...
class UserResource extends Resource
{
    ...
    protected static ?string $navigationGroup = 'Manajemen Pengguna'; // Grup baru
        ...
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('email')
                    ...
                    ->required()
                    ->maxLength(255)
                    ->unique(ignoreRecord: true), // Email harus unik, kecuali saat edit user yang sama
                Forms\Components\TextInput::make('password')
                    ->label('Password')
                    ->password()
                    ->maxLength(255)
                    ->dehydrateStateUsing(fn (string $state): string => Hash::make($state)) // Hash password sebelum disimpan
                    ->dehydrated(fn (?string $state): bool => filled($state)) // Hanya hash jika password diisi
